...
#define FFS_DIR_ADDRESS_VALID(address, offset_end) (address.block != FFS_BLOCK_FREE && address.block != FFS_BLOCK_LAST && address.block != FFS_BLOCK_INVALID && address.offset < offset_end)
